...
const LastStudentWordModuleAttemptsList = () => {
    ...
    useEffect(() => {
        const fetchLastStats = async () => {
            ...
            try {
                const response =
                    await api.post('/english-student/word-modules-attempts-page/by-teacher', {
                    englishStudentId,
                    englishTeacherId,
                ...
                console.error('Error fetching last students word modules stats:', error);
                navigate("/home");
            } finally {
                setLoading(false);
            }
    ...
    const handlePageChange = (event, value) => {
        navigate(`/word-modules/stats/eng-teacher/${englishTeacherId}/eng-student/${englishStudentId}/${value}`);
    };
            ...
            <Paper sx={{ width: '100%', maxWidth: 800, p: 3 }}>
                ...
                <Pagination
                    ...
                    renderItem={(item) => (
                        <PaginationItem
                            component={Link}
                            to={`/word-modules/stats/eng-teacher/${englishTeacherId}/eng-student/${englishStudentId}/${item.page}`}
                            {...item}
                        />
                    )}
                    boundaryCount={1}
...
export default LastStudentWordModuleAttemptsList;